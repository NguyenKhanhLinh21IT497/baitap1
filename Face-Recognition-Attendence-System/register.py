...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"D:\Face-Recognition-Attendence-System\Images_GUI\bg1.jpg")
        ...
        get_str = Label(frame,text="Register Page ",font=("times new roman",30,"bold"),fg="#002B53",bg="#F2F2F2")
